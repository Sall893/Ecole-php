...
<?php $this->view('includes/nav')?>
	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		<center><h4>Modifier Le Profile</h4></center>
		<?php if($row):?>
			...
			<div class="col-sm-8 col-md-9 bg-light p-2">
					<div class="p-4 mx-auto mr-4 shadow rounded" >
						...
						<select class="my-2 form-control" name="rank">
							...
							<option <?=get_select('rank','lecturer')?> value="lecturer">Lecteurr</option>
						...
						<br>
						<button class="btn btn-primary float-end">Sauvegarder Les Modifications</button>

						<a href="<?=ROOT?>/profile/<?=$row->user_id?>">
							<button type="button" class="btn btn-danger">Reour au profile</button>
						</a>
