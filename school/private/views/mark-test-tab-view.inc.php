...
<div class="container-fluid text-center">
	<div class="text-danger"><?=$percentage?>% Repondu</div>
	<div class="bg-primary" style="width: <?=$percentage?>%;height: 5px;"></div>

	<div class="text-danger"><?=$marked_percentage?>% Marqué</div>
...
<center>
	...
	<small style="font-size:20px">Note Devoir:<br></small> <div style="font-size: 60px;margin-top: -20px;"><?=$score_percentage?>%</div>
</center>
<?php endif;?>

<nav class="navbar">
	<center>
		<h5>Question Devoir</h5>
		<p><b>Totale Questions:</b> <?=$total_questions?></p>
	</center>
...
<form method="post">
	...
	<?php if(!$marked):?>
		<center>
			<small>Cliquer pour enregistrer avant de passer a un autre page</small><br>
