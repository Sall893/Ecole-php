	<nav class="navbar navbar-light bg-light">
	  <form class="form-inline">
		...
		<tr><th></th><th>Nom Du Devoir</th><th>Creer par</th><th>Activer</th><th>pris</th><th>Date</th>
			<th>
		...
		<?php if(isset($tests) && $tests):?>
			...
			<?php foreach ($tests as $row):?>
 			...
 			<?php endforeach;?>
			<?php else:?>
				<tr><td colspan="6"><center>pas de devoir trouve pour l'instant</center></td></tr>
			<?php endif;?>
