...
<?php $this->view('includes/nav')?>
	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
				...
				<tr>
					...
					<td>
						<a href="<?=ROOT?>/single_class/<?=$row->class_id?>?tab=tests">
							<button class="btn btn-sm btn-primary"><i class="fa fa-chevron-right"></i>Voir Classes</button>
						</a>

						<a href="<?=ROOT?>/single_test/<?=$row->test_id?>?tab=scores">
							<button class="btn btn-sm btn-primary"><i class="fa fa-chevron-right"></i>Notes Etudiants</button>
						</a>
		...
		<?php else:?>
			<center><h4>Ce Devoir n'a pas été trouvé!</h4></center>
		<?php endif;?>
