...
<center><h5>Modifier <?=$quest_type?> Question</h5></center>
...
<form method="post" enctype="multipart/form-data">
	...
	<div class="input-group mb-3 pt-3">
	  <label class="input-group-text" for="inputGroupFile01">Commentaire(optionelle)</label>
	...
	<button class="btn btn-danger float-end">Sauvegarder question</button>
	<div></div>
</form>

<?php else:?>
	Desole, question non trouvé !
	<br>
	<a href="<?=ROOT?>/single_test/<?=$row->test_id?>">
		<button type="button" class="btn btn-primary"><i class="fa fa-chevron-left"></i>Back</button>
	</a>
