<?php $this->view('includes/header')?>
	...
	<div class="container-fluid">
		...
		<div class="p-4 mx-auto mr-4 shadow rounded" style="margin-top: 50px;width:100%;max-width: 340px;">
			<h2 class="text-center">Mon Ecole</h2>
			...
			<select class="my-2 form-control" name="gender">
				<option <?=get_select('gender','')?> value="">--Selectionner un Genre--</option>
				<option <?=get_select('gender','male')?> value="male">Male</option>
				<option <?=get_select('gender','female')?> value="female">Femmele</option>
			</select>
			...
			<?php else:?>
				<select class="my-2 form-control" name="rank">
					<option <?=get_select('rank','')?> value="">--Selectionner un Rang--</option>
					<option <?=get_select('rank','student')?> value="student">Etudiant</option>
					<option <?=get_select('rank','reception')?> value="reception">Reception</option>
					<option <?=get_select('rank','lecturer')?> value="lecturer">Lecteur</option>
			...
			<br>
			<button class="btn btn-primary float-end">Ajouter Utilisateur</button>
