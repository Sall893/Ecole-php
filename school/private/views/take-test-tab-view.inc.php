...
<div class="container-fluid text-center">
	...
	<?php if($answered_test_row):?>
		<?php if($answered_test_row->submitted):?>
			<div class="text-success">Ce Devoir a deja été soumis</div>
		<?php else:?>
			<div class="text-danger">
				Ce devoir n'as pas encore été soumis<br>
				<a onclick="submit_test(event)" href="<?=ROOT?>/take_test/<?=$row->test_id?>/?submit=true">
					<button class="btn btn-danger float-end">Soummettre Le Devoir</button>
				</a>
			</div>
		<?php endif;?>
...
<form method="post">
	...
	<?php if(!$submitted):?>
		<center>
			<small>Cliquer por sauvegarder avant de passer a un autre page</small><br>
			<button class="btn btn-primary">Sauvegarder reponse</button>
		</center>
		</form>
	<?php endif;?>
<?php endif;?>
